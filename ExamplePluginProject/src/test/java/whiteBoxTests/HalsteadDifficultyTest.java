...
public class HalsteadDifficultyTest {
	...
	public void CalculateHalsteadDifficultyTest() {
		...
		doReturn(10).when(test).getUniqueOperators();
		doReturn(10).when(test).getOperands();
		doReturn(5).when(test).getUniqueOperands();
	...
	public void FinishTreeTest() {
		HalsteadDifficultyCheck test = spy(HalsteadDifficultyCheck.class);
		DetailAST ast = mock(DetailAST.class);
